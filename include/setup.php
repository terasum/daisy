 ...
 */
function daisy_register_required_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'daisy_puma',                 // Unique ID for hashing notices for multiple instances of TGMPA.
...
add_action( 'puma_register', 'daisy_register_required_plugins' );